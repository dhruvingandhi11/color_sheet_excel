...
# DB_NAMES = ["trailer_yard__4-02-06-07-19-53", "trailer_yard__1-02-06-06-49-22"]
...
for DB_NAME in DB_NAMES:
                        ...
                        if 'camera' in each_frame:
                            ...
                            if str(parking_id) == each_frame['location']:
                                ...
                                if (mongo_parking_status == 'DOCKED' or mongo_parking_status ==  'PARKED' or mongo_parking_status == 'MOVING') and actual_final_park_status == 'parked':
                                    ...
                                    full_data.append(partial_false_detail)
                                    # dict_final_job_data.update(partial_false_detail)
    ...
    # print(f"{full_data = }")
    partial_false_detail = {'total_counter' : total_counter}
    full_data.append(partial_false_detail)
