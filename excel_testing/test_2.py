...
# DB_NAMES = ["trailer_yard-01-31-09-51-52"]
# DB_NAMES = ["trailer_yard-01-31-10-02-12"]
# DB_NAMES = ["trailer_yard-01-31-10-12-33"]
# DB_NAMES = ["trailer_yard-01-31-10-22-54"]
# DB_NAMES = ["trailer_yard-01-31-10-29-45"]
# DB_NAMES = ["trailer_yard-01-31-10-50-06"]
# DB_NAMES = ["trailer_yard-01-31-11-10-27"]
# DB_NAMES = ["trailer_yard-01-31-11-30-48"]
# DB_NAMES = ["trailer_yard-01-31-11-51-08"]
# DB_NAMES = ["trailer_yard-01-31-12-11-30"]
# DB_NAMES = ["trailer_yard-01-31-12-31-50"]
# DB_NAMES = ["trailer_yard-01-31-12-52-11"]
# DB_NAMES = ["trailer_yard-01-31-13-07-06"]
                    ...
                    for each_frame in all_frames:
                        if 'camera' in each_frame:
                            ...
                            if str(parking_id) in each_frame.values():
                                ...
                                actual_final_park_status = temp_dict['status']
                                ...
                                if (mongo_parking_status == 'DOCKED' or mongo_parking_status ==  'PARKED') and actual_park_status == 'parked':
                                    print('true')
                                    color_in_df[(index, temp_count)] = "green"
                                #     # for i in columns_to_color:
                                #     #     color_in_df[(index, i)] = "green"
                                elif mongo_parking_status == 'empty' and actual_park_status == 'parked':
                                    print('false')
                                    color_in_df[(index, temp_count)] = "red"
                                        
                                elif mongo_parking_status ==  'empty' and actual_park_status == 'empty':
                                    color_in_df[(index, temp_count)] = "pink"
                                #     # for i in columns_to_color:
                                #         # color_in_df[(index, i)] = "pink"
